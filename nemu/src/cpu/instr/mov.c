...
make_instr_func(mov_rm2sreg){
	...
	//cpu.segReg[opr_dest.addr].val = opr_dest.val;
	//printf("pre seg = %x\n", cpu.segReg[opr_dest.addr].val);
	operand_write(&opr_dest);
	//printf("after seg = %x\n", cpu.segReg[opr_dest.addr].val);
